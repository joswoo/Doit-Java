...
class IntStackTesterEx_04_01 {
	public static void main(String[] args) {
		...
		IntStack_04_01 s = new IntStack_04_01(100); // 최대 100개를 푸시할 수 있는 스택
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(x);
				} catch (IntStack_04_01.OverflowIntStackException e) {
			...
			case 2: // 팝
				...
				} catch (IntStack_04_01.EmptyIntStackException e) {
